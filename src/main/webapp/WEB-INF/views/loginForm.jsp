...
<script type="text/javascript">
	function signupForm() {
		window
				.open('signupForm', 'pop',
						'resizable=no scrollbars=yes top=80 left=500 width=500 height=430');
		return false;
	}
	function signOut() {
	...
	function login() {
		...
		var myParams = {
			'clientid' : '878418668504-o095oma848mo979d6bm2md3eoopobrtn.apps.googleusercontent.com', //You need to set client id
		...
		<div class="container">
			...
			<div id="navbar" class="collapse navbar-collapse">
				<ul class="nav navbar-nav">
					...
					<li><a
						href="http://bootstrapk.com/examples/starter-template/#about">About</a></li>
					<li><a
	...
	<div class="container">
		<div class="starter-template" style="padding-top: 150px;">
			...
			<section class="min-vh-100 d-flex align-items-center">
				<div
					class="bg-img-holder section-image top-0 left-0 col-lg-6 col-xl-7 z-10 vh-100 d-none d-lg-block"
					data-background="../../img/pages/blog.jpg"></div>
				<div class="row align-items-center">
					...
					<div class="btn-wrapper my-4"
						...
						<div style="width: 50%; margin: auto;">
							<a href="#11"
								style="width: 40%; background-color: #FFAB00; color: white;"
								class="btn btn-sm btn-icon mb-1 mb-sm-0" onclick="login()">Gogle</a><input
								type="button" onclick="login()" value="fdsa"> <a
								href="#"
								style="width: 40%; background-color: #FFAB00; color: white;"
								class="btn  btn-sm btn-icon mb-1 mb-sm-0">Facebook</a>
						</div>
					...
					<div
						style="width: 500px; margin: auto; vertical-align: center; padding-top: 20px; padding-bottom: 10px;">
						<span> <input type="email" style="margin-bottom: 10px;"
							class="form-control" id="input-email" placeholder="Enter email"
							required> <input class="form-control"
							placeholder="Password" type="password" required>
						</span>

						<div
							style="width: 500px; margin: auto; vertical-align: center; padding-top: 10px; padding-bottom: 10px;">
							<div>
								<button type="submit" class="btn btn-block" onclick="login()">Login</button>
							</div>
						</div>

						<div class="b" style="display: inline-flex; width: 500px;">
							<div style="width: 50%; text-align: left;">
								<small>Not registered?</small> <a href="javascript:signupForm()"
